...
export default function Dashboard() {
    ...
    //     if (currentUser) {
    //         dispatch(enrollInCourse({ userId: "123", courseId }));
    //     }
    // };
    ...
    //     event.preventDefault();
    //     if (currentUser) {
    //         dispatch(unenrollFromCourse({ userId: "123", courseId }));
    //     }
    // };
    ...
    return (
            ...
            <div id="wd-dashboard-courses">
                <Row xs={1} md={5} className="g-4">
                    {courses
                        ...
                        //     ))
                        .filter((course) => {
        // If no current user, show all courses
        ...
        // If user has no enrollments, show only the INTRO101 course
        if (!userHasEnrollments) {
            return course._id === "INTRO101";
        }
        
        // Otherwise, show courses user is enrolled in
        return enrollments.some(
            (enrollment) =>
                enrollment.user === currentUser._id &&
                enrollment.course === course._id
            ...
            {/* {showAllCourses ? "All Courses" : "Published Courses"} ({displayedCourses.length})<hr />
            <div id="wd-dashboard-courses">
                <Row xs={1} md={5} className="g-4">
                    {courses
                        .filter((course) =>
                                        ...
                                        <CardBody className="card-body">
                                            ...
                                            {isFaculty ? (
                                                ...
                                                <>
                                                    {enrolled ? (
                                                        <button
                                                            onClick={(event) => handleUnenroll(course._id, event)}
                                                            className="btn btn-danger float-end"
                                                        ...
                                                        <button
                                                            onClick={(event) => handleEnroll(course._id, event)}
